...
```
The following analysis is based on a data set with 744088 observations with different variables which describe industry and macro characteristics. In this paper, we focus on 9 variables where 5 are industry specific and 4 are macroeconomic. \
...
Moreover, the following four macro indicators are included: dp, ep, bm and ntis, where dp is the dividend-price ratio, ep is the earnings-price ratio, bm is the book-to-market ratio and ntis is the net equity expansion. 

### OLIVER OPINION: Skal vi ikke nævne i teksten at vi filtrere data på dato, da dette er en del af spørgsmål 1? Tænker vi kan printe nedenstående del af koden så den kommer med i PDF'en? ###
