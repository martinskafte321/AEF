...
#### Then, propose an alternative strategy that may be able to effectively capture the momentum premium but which at the same time delivers lower trading costs, e.g. because the turnover is smaller, the strategy takes less extreme (short) positions or is tilted towards stocks that are cheaper to trade. Describe the strategy and implement it within the CRSP sample. Report the resulting Sharpe-ratio and average turnover and compare to the baseline momentum strategy from exercise 4.
