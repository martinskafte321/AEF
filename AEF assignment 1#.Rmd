...
tidy_finance <- dbConnect(SQLite(), "/Users/fredlundahl/Desktop/AEF/data/", 
             extended_types = TRUE)
...
all_guys %>% 
  group_by(month) %>%
  summarise(count_traded = sum(trade == 1)) #CHECK THIS - we multiply number of trades by 2 because every transaction involves both buying and selling or selling and buying at the same time
