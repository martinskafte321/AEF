...
The difference between using prices and market capitalization is rarely a large problem, but the change in market cap will always reflect a change in the public value of a company whereas a change in stock price might be due to stock split, which would have significant consequences for measuring momentum effects. 
