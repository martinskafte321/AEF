...
rbind(summaryret, summarymkt) %>% relocate(Variable) %>% kbl(caption = "Summary statistics for monthly excess returns (%) and market capitalization (Million USD)",digits = 3) %>%
