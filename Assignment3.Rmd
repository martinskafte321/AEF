...
#  Rolling Window multivariate DCC Garch

With rolling window forecasts, we recursively re estimate the GARCH model and store the one ahead covariance forecasts. Since we make use of a dynamic model, we also store conditional means. The DCC Garch 
